                ...
                <div class="row">
                    ...
                    <div class="panel-body">
                        ...
                        <form name="formulario" id="formulario"
                            action="{{ is_null($opinion->id) ? route('opinions.store') : route('opinions.update', ['id' => $opinion->id]) }}"
                            ...
                            <div class="row">
                                <div class="form-group col-md-6" @include('partials.disabled')>
                                    ...
                                    <select name="opinion_scope_id" class="select2 form-control" @include('partials.disabled')
                                        id="opinion_scope_id">
                                        ...
                                        @foreach ($opinionScopes as $key => $item)
                                            @if(!is_null($opinion->opinionScope) && $opinion->opinionScope->id == $item['id']
                                                ...
                                                <option value="{{ $item['id'] ?? null }}" selected="selected">{{ $item['name'] ?? null }}
                                                </option>
                                            @else
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <polymorphic-select alljson="{{ collect($authorables) }}"
                                        selected="{{ $selectedAuthorableKey ?? null }}" idname="authorable_id"
                                        typename="authorable_type" showname="Procurador" disabled="{{ $formDisabled }}"
                                        dusk="authorable-select"></polymorphic-select>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6" @include('partials.disabled')>
                                    ...
                                    <select name="approve_option_id" class="select2 form-control" @include('partials.disabled')
                            ...
                            <div class="row">
                                <div class="form-group col-md-6" @include('partials.disabled')>
                                    ...
                                    <select name="opinion_type_id" class="select2 form-control" @include('partials.disabled')
                                        id="opinion_type_id">
                                        <option value="">SELECIONE</option>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6" @include('partials.disabled')>
                                    ...
                                    <input name="suit_number"
                                        value="{{ is_null(old('suit_number')) ? $opinion->suit_number : old('suit_number') }}"
                                        @include('partials.readonly') class="form-control" id="suit_number"
                                        aria-describedby="nomeHelp" placeholder="Número do Processo">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6" @include('partials.disabled')>
                                    ...
                                    <input name="identifier"
                                        value="{{ is_null(old('identifier')) ? $opinion->identifier : old('identifier') }}"
                                        @include('partials.readonly') class="form-control" id="identifier"
                                        aria-describedby="nomeHelp" placeholder="Identificador">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6" @include('partials.disabled')>
                                    ...
                                    <input name="suit_sheet"
                                        value="{{ is_null(old('suit_sheet')) ? $opinion->suit_sheet : old('suit_sheet') }}"
                                        @include('partials.readonly') class="form-control" id="suit_sheet"
                                        aria-describedby="nomeHelp" placeholder="Folha do Processo">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6" @include('partials.disabled')>
                                    ...
                                    <input
                                        ...
                                        type="date" class="form-control" name="date" id="date" @include('partials.readonly') />
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6" @include('partials.disabled')>
                                    ...
                                    <input name="party" value="{{ is_null(old('party')) ? $opinion->party : old('party') }}"
                                        @include('partials.readonly') class="form-control" id="party" aria-describedby="nomeHelp"
                            ...
                            <div class="row">
                                <div class="form-group col-md-6" @include('partials.disabled')>
                                    @if(!isset($opinion->file_pdf))
                                        ...
                                        <input style="{{ $mode == 'create' ? '' : 'display: none;' }}" name="pdf_file" id="pdf_file"
                                            type="file" @include('partials.disabled') />
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6" @include('partials.disabled')>
                                    @if(!isset($opinion->file_doc))
                                        ...
                                        <input style="{{ $mode == 'create' ? '' : 'display: none;' }}" name="doc_file" id="doc_file"
                                            type="file" @include('partials.disabled') />
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6" @include('partials.disabled')>
                                    ...
                                    <input id="is_active" type="checkbox" name="is_active"
                                        {{ (is_null(old('is_active')) ? ((is_null($opinion->is_active) ? (true ? 'checked="checked"' : '') : $opinion->is_active) ? 'checked="checked"' : '') : old('is_active')) ? 'checked="checked"' : '' }}
