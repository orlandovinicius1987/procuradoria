...
{{--        </div>--}}
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <textarea v-model="form.site_alerj_link" class="form-control" @include('partials.readonly') id="site_alerj_link"
        ...
        <div class="col-md-4">
            <div class="form-group">
                <label for="data_arquivamento1">Data do arquivamento</label>
                ...
                <input
                        ...
                        class="form-control"
                        id="data_arquivamento1" @include('partials.readonly')
                />
